...
export const CHANGELOG = [
  ...
  },
  {
    ...
    date: '2026-09-20',
    changes: [
      'Tableau de bord : barre de navigation rapide (collée en haut au défilement) vers Chiffres, Graphiques, Relances, Suggestions, Sans suite & refus',
    ],
  },
  {
    version: '2.30.0-démo',
  ...
  },
  {
    ...
    changes: [
      ...
      '✨ Rédiger un e-mail et Brief avant l\'appel tiennent compte des actualités presse de l\'entreprise quand elles sont pertinentes',
    ],
  },
  {
    version: '2.27.0-démo',
