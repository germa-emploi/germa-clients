...
import ReunionCommerciale from './pages/ReunionCommerciale'
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={
        ...
        <Route path="reunion-commerciale" element={<ProtectedRoute adminOnly><ReunionCommerciale /></ProtectedRoute>} />
